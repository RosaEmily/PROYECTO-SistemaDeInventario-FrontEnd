    ...
    export default {
        ...
        methods: {
            ...
            async getInfoByID(id) {
                ...
                this.entidad_razon_social=respRoles.proveedor.nombre;
                this.data.entidad_direccion=respRoles.proveedor.direccion;
                this.data.proveedor=respRoles.proveedor;
            ...
            async getConfiguraciones(){                
                ...
                let suc4 = {
                    url: "/api/notaCredito/Listcompras",
                    method: "GET",
                };
