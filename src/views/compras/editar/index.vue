    ...
    export default {
        ...
        methods: {
            async getInfoByID(){
                ...
                this.tipo.desc=this.tipo.doc.text
            ...
            doubleClickKardex(item,index){
                if(item.libd_kardex){
                    ...
                    this.sendMessage("Seleccione un KARDEX que permita añadir productos","AlertTriangleIcon","danger")
                }
            },
            ...
            async saveCompra(){
                ...
                try{
                    ...
                    if(respRoles.status==200){
                        this.sendMessage('Compra editada satisfactoriamente',"EditIcon","success")
                        this.$router.push({ name: "compras-lista-index" });
                    }else if(respRoles.status==500){
                        this.sendMessage('Error de servidor',"AlertTriangleIcon","danger")
                    }else{
