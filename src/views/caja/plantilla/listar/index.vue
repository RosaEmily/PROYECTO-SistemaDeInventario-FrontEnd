...
export default {
        ...
        return {
            ...
            paramsGrid: {
                ...
                fields: [
                    ...
                    { key: "pl_glosa", label: "Glosa", sortable: true },
                    {
                        key: "actions",
                        label: "Acciones",
                        tdClass: "text-center",
                ...
                urlBack: "/api/plantillaCajaBanco/1/MB",
                edit: {
                    available: true,
                    redirect: true,
                    ruta: "/caja/plantilla/editar",
                },
                delete: {
                    available: true,
                    ruta: "/api/plantillaCajaBanco",
                },
                options: {
                    responsive: true,
                    primaryKey: "id",
    ...
    methods: {
        ...
        agregarCuenta() {
            this.$router.push({ name: "caja-plantilla-agregar" });
        },
    },
};
</script>
