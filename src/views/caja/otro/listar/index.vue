    ...
    export default {
        ...
        data() {
            return {
                ...
                paramsGridPlantilla: {
                    ...
                    urlBack: "/api/pago_cobro/plantillas/1/MB/2",
                    edit: {
                        available: true,
                        redirect: true,
        ...
        methods: {
            ...
            async loadDataSource2(){
                this.dataSource2=[];              
                let request = {
                    url: "/api/pago_cobro/allotro/1/1",
                    method: "GET",
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("accessToken")}`,
                    },
            ...
            verElement(item){
                localStorage.setItem("idPlantillaCajaBancoOtro", item.id);                
                this.$router.push({ name: "caja-otro-agregar" });                
            },
            ...
            showItem(item){
                this.$router.push("/caja/otro/ver/" + item.id);
            }
        },
    };
</script>
