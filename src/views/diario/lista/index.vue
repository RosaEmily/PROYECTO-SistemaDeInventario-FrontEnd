...
<script>
    ...
    export default {
        ...
        data() {
            return {
                ...
                paramsGridPlantilla: {
                    ...
                    urlBack: "/api/diario/plantillas/1/MD",
                    edit: {
                        available: true,
                        redirect: true,
        ...
        methods: {
            ...
            verElement(item){
                localStorage.setItem("idPlantillaDiario", item.id);                
                this.$router.push({ name: "diario-agregar-index" });                
            },
            ...
            showItem(item){
                this.$router.push("/diario/ver/" + item.id);
            }
        },
    };
</script>
