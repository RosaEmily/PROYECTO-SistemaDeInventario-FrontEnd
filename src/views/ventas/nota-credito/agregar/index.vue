            ...
            <validation-observer ref="agregarVentaRules">
                <b-form>
                    <b-row>
                        ...
                        <b-col sm="2">
                            <b-form-group label="Doc. Referencia: " v-if="st_nota_credito">
                                <b-button 
                                    class="btn-secondary"
                                    style="width: 100%"
    ...
    export default {
        ...
        data() {
            return {
                ...
                compraData: {
                    ...
                    lib_modulo: "MV",                               //variables por defecto
        ...
        methods: {
            async getInfoByID(id){     
                ...
                this.compraData.venta_id=respRoles.id
                        ...
                        axios
                            ...
                            .then((result) => {
                                if (result.data.success) {
                                    ...
                                    this.sendMessage("Ocurrió un error","error");
                                    this.compraData.ca_tipo_cambio = "";
                                }
                            });
                    } else {
