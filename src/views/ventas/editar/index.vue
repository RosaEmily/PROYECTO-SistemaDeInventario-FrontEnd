        ...
        methods: {
            ...
            async saveProveedor(){
                ...
                try{
                    ...
                    if (respRoles == 201) {
                        ...
                        var resp = await store.dispatch("back/EXECUTE", suc2);
                        this.entidad = resp; 
                        this.data.cliente=this.entidad.find((ent) => ent.doi == this.suplierData.doi);
            ...
            async saveCompra(){
                ...
                try{
                    var respRoles = await store.dispatch('back/EXECUTE',request)
                    if(respRoles==201){
                        this.sendMessage('Venta editada satisfactoriamente',"CheckSquareIcon","success")
                        this.$router.push({ name: "ventas-lista-index" });
                    }else if(respRoles==400){
