    ...
    export default {
        ...
        methods: {
            async getInfoByID(){
                ...
                let request= {
                    url:"/api/venta/"+this.$route.params.id,
                    method:"GET",
                }
                ...
                this.compraData.ca_doi=this.supliers.find((sup) => sup.cli_doi == respRoles.ca_doi)
                ...
                this.compraData.ca_tipo_doc=respRoles.ca_tipo_doc
                this.tipo.doc.text=this.tipos_doc.find((doc) => doc.value == respRoles.ca_tipo_doc).text
                this.tipo.desc=this.tipos_doc.find((doc) => doc.value == respRoles.ca_tipo_doc).text
                this.tipo.doc.value=this.tipos_doc.find((doc) => doc.value == respRoles.ca_tipo_doc).value
                this.tipo.doc.maxLengthCorr=this.tipos_doc.find((doc) => doc.value == respRoles.ca_tipo_doc).maxLengthCorr
                this.compraData.prov_id=respRoles.prov_id  
                this.compraData.per_id=respRoles.per_id  
                this.compraData.suc_id=respRoles.suc_id
                this.compraData.pa_fecha_emision=respRoles.ca_created_at
                this.compraData.pa_fecha_vencimiento=respRoles.cobro.co_fecha_vencimiento
                ...
                respRoles.libro.detalle_libro.forEach(element => {       
                    if(element.libd_id_padre==null){
                        ...
                        this.compraData.detalle_libro.push({
                            ...
                            libd_dh: element.libd_dh,
                            libd_debe: element.libd_debe,
                            libd_haber: element.libd_haber,
                            libd_nro_cta: element.libd_nro_cta,
                            libd_id_cta: element.libd_id_cta,
                            libd_debe_cambio: element.libd_debe_cambio,
                            libd_haber_cambio: element.libd_haber_cambio,
                        ...
                        this.compraData.detalle_hijo.push({
                            ...
                            libd_desc: element.libd_descripcion,
                            libd_dh: element.libd_dh,
                            libd_debe: parseFloat(element.libd_debe).toFixed(2),
                            libd_haber: parseFloat(element.libd_haber).toFixed(2),
                            libd_nro_cta: element.libd_nro_cta,
                            libd_id_cta: element.libd_id_cta,
                            libd_debe_cambio: element.libd_debe_cambio,
                            libd_haber_cambio: element.libd_haber_cambio,
            ...
            async getConfiguraciones() {
                ...
                var resp = await store.dispatch("back/EXECUTE", suc);
                this.supliers = "";
                this.supliers = resp.rows;
                let request = {
            ...
            async saveCompra(){
                ...
                try{
                    ...
                    if(respRoles.status==200){
                        this.sendMessage('Venta editada satisfactoriamente',"EditIcon","success");
                        this.$router.push({ name: "ventas-lista-index" });
                    }else if(respRoles.status==500){
                        this.sendMessage('Error de servidor',"AlertTriangleIcon","danger");
                    }
