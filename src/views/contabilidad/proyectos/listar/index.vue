...
export default {
        ...
        return {
            ...
            paramsGrid: {
                ...
                fields: [
                    ...
                    { key: "proy_codigo", label: "Código", sortable: true },
                    {
                        key: "proy_descripcion",
                        label: "Descripción",
                        sortable: true,
                    },
                    { key: "proy_fecha_inicio", label: "Fecha Inicial", sortable: true },
                    { key: "proy_fecha_final", label: "Fecha Final", sortable: true },
                    {
                        key: "actions",
                        label: "Acciones",
                        tdClass: "text-center",
                ...
                edit: {
                    available: true,
                    redirect: true,
                    ruta: "/contabilidad/proyecto/editar",
                },
                delete: {
                    available: true,
                    ruta: "/api/proyecto",
    ...
    methods: {
        ...
        agregarCuenta() {
            this.$router.push({ name: "proyecto-agregar-index" });
        },
    },
};
</script>
