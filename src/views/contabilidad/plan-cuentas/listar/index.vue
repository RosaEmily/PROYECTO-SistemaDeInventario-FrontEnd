...
export default {
        ...
        return {
            ...
            paramsGrid: {
                ...
                fields: [
                    ...
                    { key: "plc_codigo", label: "Código", sortable: true },
                    {
                        key: "plc_descripcion",
                        label: "Descripción",
                        sortable: true,
                    },
                    { key: "plc_moneda", label: "Moneda", sortable: true },
                    {
                        key: "actions",
                        label: "Acciones",
                        tdClass: "text-center",
                ...
                edit: {
                    available: true,
                    redirect: true,
                    ruta: "/contabilidad/editar",
                },
                delete: {
                    available: true,
                    ruta: "/api/cctacontable",
                },
                options: {
                    responsive: true,
                    primaryKey: "id",
    ...
    methods: {
        ...
        agregarCuenta() {
            this.$router.push({ name: "contabilidad-agregar" });
        },
    },
};
</script>
